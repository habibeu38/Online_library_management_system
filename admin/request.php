...
<div class="container">
	...
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT user.username,id,books.bid,name,authors,edition,status FROM user inner join issue_book ON user.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve =''";
